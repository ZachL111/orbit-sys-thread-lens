"""Regression checks for the orbit-sys-thread-lens casebook."""
...
from casebook.harness import assert_expected, orbit_sys_thread_lens_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(orbit_sys_thread_lens_summary(), assert_expected())
